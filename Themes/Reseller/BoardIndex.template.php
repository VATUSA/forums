...
function template_main()
{
	...
	echo '<div style="text-align: right"><a href="/index.php?action=unread;all;start=0">Read all unread</a> | <a href="/?action=markasread;sa=all;' . $context['session_var'] . '=' . $context['session_id'] . '">Mark all as read</a></div>
